...
public final class Main extends javax.swing.JFrame {
    ...
    private void jUpdateProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateProductActionPerformed
        ...
        try {
            ...
            /**
             * Khong tu y generate key lung tung roi mapping voi index cua list
             * sua lai cho dung key, no se chuyen key sang so khac trong forein
             * Tu generate se rac roi khi phai update reference lam sai logic 
     ...
     * 
     * @param ID
     * @return result that contain index of Combobox
     * this function written in case dev cannot getID in object that
     * contain in jcategorycb
     */
     ...
     * 
     * @param categoryName
     * @return primary key of category in database
     * to mapping foreinkey on product to perform update
     */
    ...
    private void jInsertProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jInsertProductActionPerformed
        ...
        try {
            ...
            ProductDTO dto = new ProductDTO(productID, productName, categoryID, price, quantity);
            ProductDAO dao = new ProductDAO();
            boolean check = dao.insertProduct(dto);
            if (check) {
                JOptionPane.showMessageDialog(this, "Success!");
            } else {
            ...
            JOptionPane.showMessageDialog(this, "Price and Quantity must be a number");
        }
        jTable.updateUI();
        firstController();
    ...
    private void jInsertCateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jInsertCateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Key is duplicated");
        }
        firstController();
    ...
    private void jDelCateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDelCateActionPerformed
        ...
        String categoryName = jCateList.getSelectedValue();
        try {
            if (!dao.checkDataOnCategory(categoryName)) {
                dao.deleteCategory(categoryName);
                JOptionPane.showMessageDialog(this, "Success!");
            } else {
                JOptionPane.showMessageDialog(this, "Cannot delete category if "
                        + "there are at least a tuple inside");
            }
        } catch (Exception ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, ex);
    ...
    private javax.swing.JComboBox<Object> jCategorycb;
