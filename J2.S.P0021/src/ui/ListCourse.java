...
public class ListCourse extends javax.swing.JFrame {
    ...
    public ListCourse() {
        ...
        jListCourse.setEditable(false);
        CourseDAO dao = new CourseDAO();
        List<CourseDTO> list = null;
        try {
            list = dao.listAllcourse();
            if (!list.isEmpty()) {
                for (CourseDTO courseDTO : list) {
                    String code = courseDTO.getCode();
                    String name = courseDTO.getName();
                    int credit = courseDTO.getCredit();
                    jListCourse.append(code + " | " + name + " | " + credit + "\n");
                }
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jListCourse = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jListCourse.setColumns(20);
        jListCourse.setRows(5);
    ...
    private javax.swing.JTextArea jListCourse;
